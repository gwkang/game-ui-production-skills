...
Use [references/component-catalog.schema.json](references/component-catalog.schema.json) when creating a machine-readable catalog. Run `scripts/validate_component_catalog.py CATALOG.json PROFILE.json` to enforce cross-field profile, evidence-coverage, identity, and approval invariants.
