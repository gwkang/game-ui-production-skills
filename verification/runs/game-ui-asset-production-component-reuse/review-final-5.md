# game-ui-asset-production post-review pressure run 5
...
Packet downstream: BLOCKED — missing all-visible-family inventory and target-size composed-screen source-parity evidence.

Sequence: reject PNG/atlas → retain canonical binding → collect packet evidence → implementation → runtime validation.
