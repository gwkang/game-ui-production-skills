...
DRAFT asset-readiness packet — no files changed.
...
Packet downstream: BLOCKED — missing target-size composed-screen source-parity evidence and visible-family inventory.

The PNG/atlas proposal replaces the approved code-native representation and omits `pressed`; reject it.

Next route: game-ui-component-system

Required gate sequence: packet-wide source-parity evidence -> implementation -> runtime validation -> UI acceptance.
