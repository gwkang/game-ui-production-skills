...
`Packet downstream: BLOCKED — missing visible-art-family inventory and target-size composed-screen source-parity evidence for the reward screen.`

After implementation, runtime validation verifies the states and landmarks.
