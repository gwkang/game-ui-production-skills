...
`Packet downstream: BLOCKED — missing visible-art-family source-parity manifest and target-size composed-screen reuse evidence`

Complete packet evidence, implement, then perform runtime validation.
