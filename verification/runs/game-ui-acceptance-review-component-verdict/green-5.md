...
reuse:primary-action@2.1.0 | catalog-abc | build-123 | reward-screen | ui-components/PrimaryButton | default, pressed | cap-390-default, cap-320-default, cap-390-pressed-old | default verified; pressed has no current protected-property evidence | P1 | REJECTED
Decision: REJECT UI
...
PASS: exact copied cells, ordered raw IDs, severity, component verdict, UI decision, and route.
